...
import { SYSeniorPortfolioValue, fetchSYSeniorPortfolioValues } from 'modules/smart-yield/api';
import { useWallet } from 'wallets/wallet';

type ChartEntity = SYSeniorPortfolioValue;
          ...
          <ReCharts.AreaChart data={state.data}>
            ...
            <ReCharts.Tooltip
              ...
              formatter={(value: number) => (
                <Text type="p2" tag="span" weight="semibold" color="green">
