  ...
  return (
    <>
      ...
      <div className="flex align-center mb-32">
        <Text type="h3" weight="semibold" color="primary">Active positions</Text>
        <Popover
          title="Filters"
          overlayStyle={{ width: 348 }}
          content={<>
            <Text type="small" weight="semibold" color="secondary" className="mb-8">Originator</Text>
            <Select
              loading={false}
              disabled={false}
              ...
              style={{ width: '100%' }}
            />
            <Text type="small" weight="semibold" color="secondary" className="mb-8">Token</Text>
            <Select
              loading={false}
              disabled={false}
              ...
              style={{ width: '100%' }}
            />
            <Text type="small" weight="semibold" color="secondary" className="mb-8">Transaction type</Text>
            <Select
              loading={false}
              disabled={false}
            ...
            <div className="flex">
              ...
              <Button type="primary" className="ml-auto">Apply filters</Button>
            </div>
          </>}
          visible={visible}
      ...
      <div className="grid flow-col gap-32">
        <Card noPaddingBody>
          <div className="flex p-24">
            ...
            <div>
              <Text type="p1" weight="semibold" color="primary" className="mb-4">USDC</Text>
