    ...
    <>
      <Grid flow="col" gap={24} className="mb-64">
        <NavLink to="/smart-yield/portfolio" exact className="tab-card" activeClassName="active">
          ...
          <Grid flow="row">
            <Text type="p1" weight="semibold" color="primary">Overview</Text>
            <Text type="small" weight="semibold" color="secondary">Statistics</Text>
          </Grid>
        </NavLink>
        <NavLink to="/smart-yield/portfolio/senior" className="tab-card" activeClassName="active">
          ...
          <Grid flow="row">
            <Text type="p1" weight="semibold" color="primary">Senior tranche</Text>
            <Text type="small" weight="semibold" color="secondary">Positions</Text>
          </Grid>
        </NavLink>
        <NavLink to="/smart-yield/portfolio/junior" className="tab-card" activeClassName="active">
          ...
          <Grid flow="row">
            <Text type="p1" weight="semibold" color="primary">Junior tranche</Text>
            <Text type="small" weight="semibold" color="secondary">Positions</Text>
          </Grid>
        </NavLink>
      </Grid>
