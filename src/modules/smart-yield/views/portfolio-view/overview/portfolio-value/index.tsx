...
import { SYPortfolioValue, fetchSYPortfolioValues } from 'modules/smart-yield/api';
import { useWallet } from 'wallets/wallet';

type ChartEntity = SYPortfolioValue;
      ...
      <Spin spinning={state.loading}>
        <ReCharts.ResponsiveContainer width="100%" height={225}>
          <ReCharts.AreaChart data={state.data}>
            ...
            <ReCharts.Area
              name="Value "
              dataKey={(item: SYPortfolioValue) => item.seniorValue + item.juniorValue}
              type="monotone"
