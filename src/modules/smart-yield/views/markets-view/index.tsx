  ...
  return (
    <div>
      <Grid flow="col" gap={24} className="mb-64">
        <TabCard title="Compound" subtitle="Markets" icon={<Icons name="compound" width={40} height={40} />} active /* type="button" onClick={() => console.log('asd')} */ />
        <TabCard title="Aave" subtitle="Markets" icon={<Icons name="aave" width={40} height={40} />} /* type="button" onClick={() => console.log('asd')} */ />
        <TabCard title="Cream Finance" subtitle="Markets" icon={<Icons name="cream_finance" width={40} height={40} />} /* type="button" onClick={() => console.log('asd')} */ />
        <TabCard title="Yearn Finance" subtitle="Markets" icon={<Icons name="yearn_finance" width={40} height={40} />} /* type="button" onClick={() => console.log('asd')} */ />
      </Grid>
      <Paragraph type="p1" semiBold color="grey500" className="mb-8">Compound total liquidity</Paragraph>
      <Heading type="h2" color="grey900" bold className="mb-40">$ 1,643,900,581.86</Heading>
      <Card
        // title={
        //   <Paragraph type="p1" semiBold color="grey900">
        //     Voter weights
