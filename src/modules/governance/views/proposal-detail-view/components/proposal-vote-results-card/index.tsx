...
const ProposalVoteResultsCard: React.FunctionComponent = () => {
  ...
  return (
    <Card
      ...
      title={(
        <Paragraph type="p1" semiBold color="grey900">Vote results</Paragraph>
      )}
      extra={(
        <Button
          type="link"
      ...
      <Grid flow="row" className={s.row}>
        <Grid flow="col" justify="space-between">
          <Grid flow="row" gap={4}>
            <Small semiBold color="grey500">For</Small>
            <Grid flow="col" gap={8}>
          ...
          <Grid flow="row" gap={4}>
            <Small semiBold color="grey500" align="right">Against</Small>
            <Grid flow="col" gap={8}>
              <Paragraph type="p1" semiBold color="grey900">
      ...
      <Grid flow="row" className={s.row}>
        <Grid flow="col" justify="space-between">
          <Grid flow="row" gap={4}>
            <Small semiBold color="grey500">Quorum</Small>
            <Grid flow="col" gap={8}>
              <Paragraph type="p1" semiBold color="grey900">
          ...
          <Grid flow="row" gap={4}>
            <Small semiBold color="grey500" align="right">Approval</Small>
            <Grid flow="col" gap={8}>
              <Paragraph type="p1" semiBold color="grey900">
                {proposalCtx.forRate?.toFixed(2)}%
              </Paragraph>
