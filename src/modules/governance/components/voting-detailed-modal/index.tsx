  ...
  return (
    <Modal className={s.component} title="Voting power detailed view" {...props}>
      <dl className={s.list}>
        <div className={s.row}>
          <dt className={s.term}>
            <Icon name="wallet" size={20} className={s.termIcon} />
            My staked balance
          </dt>
          <dd className={s.data}>
            {formatToken(myBondBalance)}
            <Icon name="plus-circle" size={20} color="green" className={s.dataIcon} />
          </dd>
        </div>
        <div className={s.row}>
          <dt className={s.term}>
          ...
          <dd className={s.data}>
            ...
            <Icon name="minus-circle" size={20} color="red" className={s.dataIcon} />
          </dd>
        </div>
        <div className={s.row}>
          <dt className={s.term}>
            <Icon name="bonus" size={20} className={s.termIcon} />
        ...
        <div className={s.row}>
          <dt className={s.term}>
            <Icon name="delegated" size={20} className={s.termIcon} />
            Delegated to me
          </dt>
          <dd className={s.data}>
            {formatToken(delegatedPower)}
            <Icon name="minus-circle" size={20} color="green" className={s.dataIcon} />
          </dd>
        </div>
        <div className={s.separator} />
        <div className={s.row}>
          <dt className={s.term}>
            <Icon name="voting-power" size={20} className={s.termIcon} />
