...
const AddZerosPopup: React.FunctionComponent<PopoverProps & AddZerosPopupProps> = props => {
  ...
  const content = (
    <Grid flow="row" gap={24}>
      <Grid flow="row" gap={8}>
        <Small semiBold color="grey500">Number of zeros</Small>
        <Grid flow="col" gap={16}>
          <Button type="ghost" onClick={() => setValue('6')}>6</Button>
          <Button type="ghost" onClick={() => setValue('8')}>8</Button>
          <Button type="ghost" onClick={() => setValue('18')}>18</Button>
      ...
      <Grid flow="col" gap={16} justify="space-between">
        <Button type="ghost" onClick={handleCancel}>Cancel</Button>
        <Button type="primary" onClick={handleAddZeros}>Add zeros</Button>
      </Grid>
    </Grid>
  );
